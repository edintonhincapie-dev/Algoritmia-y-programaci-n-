...
* Registro de Usuarios: El sistema debe registrar clientes validando que el nombre y apellido no contengan numeros ni tengan menos de 3 letras. El documento debe poseer entre 8 y 10 dígitos puramente numericos (Documento Colombiano). El correo debe contener un "@" y terminar en ".com". Ademas, se debe asignar obligatoriamente un tiempo de prestamo de 5, 10, 15 o 30 días.
